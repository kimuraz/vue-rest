...
var VueRest = {
  install: function install(Vue, options) {
    ...
    if (options && options.axiosOptions) {
      api = __WEBPACK_IMPORTED_MODULE_2_axios___default.a.create(options.axiosOptions);
      if (options.axiosOptions.localStorageAuthorization) {
        var localStorageAuthorization = options.axiosOptions.localStorageAuthorization;
        api.interceptors.request.use(function (config) {
          var token = localStorage.getItem(localStorageAuthorization.tokenItem);
          var prefix = localStorageAuthorization.prefix;
          if (!localStorageAuthorization.tokenItem || !prefix) {
            console.error('[ERR - VueRest]: Miss configuration at localStorageAuthorization.');
          }
          if (token) {
            __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_object_assign___default()(config.headers, { Authorization: prefix + ' ' + token });
          }
        });
      }
    }
    if (!api) {
      api = __WEBPACK_IMPORTED_MODULE_2_axios___default.a.create();
    }
    Vue.api = api;
...
/* harmony default export */ __webpack_exports__["default"] = (VueRest);
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(5), __webpack_require__(47)))
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  methods: {
    loadList: function loadList() {
      var callback = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : function (response) {};
      var errCallback = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : function (err) {};

      this.$api.get(this.route).then(function (response) {
        callback(response);
      }).catch(function (err) {
        errCallback(err);
      });
    ...
    deleteObj: function deleteObj(objId) {
      ...
      var callback = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : function (response) {};
      var errCallback = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : function (err) {};

      this.$api.delete(this.route + '/' + objId + '/').then(function (response) {
        callback(response);
        _this.$emit('delete', objId);
      }).catch(function (err) {
        errCallback(err);
      });
    },
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  methods: {
    create: function create() {
      var saveCallback = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : function (response) {};
      var errCallback = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : function (err) {};

      this.$api.post(this.route, this.requestObj).then(function (response) {
    ...
    update: function update() {
      ...
      this.$api.patch(this.route, this.requestObj).then(function (response) {
        saveCallback(response);
      }).catch(function (err) {
        errCallback(err);
      });
    ...
    load: function load(id) {
      ...
      if (id) {
        this.$api.get(this.route + "/" + id + "/").then(function (response) {
          _this.requestObj = response.data;
        }).catch(function (err) {
          errCallback(err);
        });
      }
